...
soup = BeautifulSoup(requests.get("https://api7.esv2.com/v2/Api/SummaryStatistics?apiKey=p5qnbI5yxR2n7aGOf5yB"
                                  " &startDate=2021-01-01&endDate=" + today + "&grouping=Date").content, "html.parser")
...
df = pd.DataFrame(list(zip(date, sent[1:], bounced[1:], delivered[1:], opens[1:], uniqueopens[1:], clicks[1:],
                           uniqueclicks[1:], clickers[1:], complaints[1:], unsubscribes[1:],
                           goals[1:], goalsvalue[1:])),
